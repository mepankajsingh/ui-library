...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Find the perfect UI library for your JavaScript framework project"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"UI Library Directory"};
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "supabase": {
      ...
      "cookieName": "sb",
      "cookiePrefix": "sb-tcblwrhrgeaxfpcvmema-auth-token",
      "useSsrCookies": true,
      "cookieOptions": {
        "maxAge": 28800,
        "sameSite": "lax",
